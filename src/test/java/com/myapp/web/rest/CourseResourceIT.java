...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).duration(DEFAULT_DURATION);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).duration(UPDATED_DURATION);
        return course;
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).duration(UPDATED_DURATION);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).duration(UPDATED_DURATION);
