...
/**
 * REST controller for managing {@link com.myapp.domain.Discipline}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DisciplineResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/disciplines/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Discipline> partialUpdateDiscipline(
        ...
        Optional<Discipline> result = disciplineRepository
            ...
            .map(existingDiscipline -> {
                ...
                if (discipline.getCredits() != null) {
                    existingDiscipline.setCredits(discipline.getCredits());
                }
                if (discipline.getPhone() != null) {
                    existingDiscipline.setPhone(discipline.getPhone());
                }
